...
import com.recyclerview.bean.ImageModel;
...
public class FrescoActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    final GridLayoutManager manager = new GridLayoutManager(this, 4, LinearLayoutManager.VERTICAL, false);
    ...
    listItem.addAll(Arrays.asList(GOOGLEIMGARY).subList(0, 10));
